...
import userLogo from "../../assets/profile-01.png"
  ...
  return (
    <div className='pl-[350px] py-20 pr-20 mx-auto px-4'>
      ...
      <div className='flex relative w-[300px] mt-6'>
        ...
        <Input value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10" placeholder="Search here..." />
      </div>
      <div className='grid grid-cols-3 gap-7 mt-7'>
        {
          filteredUsers.map((user, index) => {
            return <div key={index} className='bg-orange-100  p-5 rounded-lg'>
              <div className='flex items-center gap-2'>
                <img src={user?.profilePic || userLogo} alt="" className='rounded-full w-16 aspect-square object-cover border border-orange-600' />
                <div>
