...
const AdminSales = () => {
  ...
  return (
    <div className='pl-[350px] bg-gray-100 py-20 mx-auto px-4'>
      <div className='p-6 grid-6 gap-6 lg:grid grid-cols-4'>

        <Card className="bg-orange-500 text-white shadow">
          <CardHeader>
            <CardTitle>
              Total Users
            </CardTitle>
          ...
          <CardContent style={{ height: 300 }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={stats.salesByDate}>
                ...
                <YAxis />
                <Tooltip />
                <Area type="monotone" dataKey="amount" stroke='#FFA500' fill='#FFA500' />
